...
const Update = () => {
  ...
  return (
    ...
    <form className={styles.form_container} onSubmit={handleSubmit}>
      ...
      <div>
        <label htmlFor="companyPassword">Company Pass:</label>
        <input
      ...
      <div>
        <label htmlFor="profileImage">Company Image:</label>
        <input type="file" id="profileImage" name="profileImage" onChange={handleImageChange} className={styles.input}/>
      </div>

      <button type="submit"  className={styles.green_btn} >Update Information </button>
