...
export const card = <FontAwesomeIcon icon={faCreditCard} />;
...
export const cardBrand = <FontAwesomeIcon icon={faCcVisa} />; // Assuming 'card' is for card type, using 'cardBrand' for card brand
